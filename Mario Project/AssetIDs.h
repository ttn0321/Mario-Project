...
#define OBJECT_TYPE_QUESTION 7
#define OBJECT_TYPE_KOOPA 8
#define OBJECT_TYPE_BOX 9
#define OBJECT_TYPE_BACKGROUND_HORIZONTAL 10
#define OBJECT_TYPE_BACKGROUND_VERTICAL 11
#define OBJECT_TYPE_FIRE_PLANT 12
#define OBJECT_TYPE_FIREBALL 13
#define OBJECT_TYPE_PIPE 14
#define OBJECT_TYPE_LEAF 15
#define OBJECT_TYPE_SWITCH 16
...
#define ID_SPRITE_QUESTION 70000
#define ID_SPRITE_QUESTION_BEFORE (ID_SPRITE_MUSHROOM + 1000)
#define ID_SPRITE_QUESTION_AFTER (ID_SPRITE_MUSHROOM + 2000)
...
#define ID_SPRITE_KOOPA_SHELL (ID_SPRITE_KOOPA + 3000)

#define ID_SPRITE_BOX 90000
#define ID_SPRITE_BOX_TOP_LEFT (ID_SPRITE_BOX+1000)
#define ID_SPRITE_BOX_TOP_CENTER (ID_SPRITE_BOX+2000)
#define ID_SPRITE_BOX_TOP_RIGHT (ID_SPRITE_BOX+3000)
#define ID_SPRITE_BOX_MIDDLE_LEFT (ID_SPRITE_BOX+4000)
#define ID_SPRITE_BOX_MIDDLE_CENTER (ID_SPRITE_BOX+5000)
#define ID_SPRITE_BOX_MIDDLE_RIGHT (ID_SPRITE_BOX+6000)
#define ID_SPRITE_BOX_BOTTOM_LEFT (ID_SPRITE_BOX+7000)
#define ID_SPRITE_BOX_BOTTOM_CENTER (ID_SPRITE_BOX+8000)
#define ID_SPRITE_BOX_BOTTOM_RIGHT (ID_SPRITE_BOX+9000)
